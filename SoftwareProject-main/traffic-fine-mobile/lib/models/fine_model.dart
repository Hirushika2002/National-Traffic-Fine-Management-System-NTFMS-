...
class FineModel {
  ...
  factory FineModel.fromJson(Map<String, dynamic> json) {
    return FineModel(
      id: json['id'] as int?,
      fineReferenceNumber: json['fineReferenceNumber'] as String? ?? json['referenceNo'] as String? ?? json['refNo'] as String? ?? '',
      categoryId: (json['categoryId'] != null ? json['categoryId'].toString() : null) ?? json['category']?['code']?.toString() ?? json['category']?.toString() ?? '',
      ...
      violatorLicenseNumber: json['violatorLicenseNumber'] as String? ?? json['driverLicenseNo'] as String? ?? json['driverLicense'] as String? ?? '',
      violationType: json['violationType'] as String? ?? json['category']?['description'] as String? ?? json['category'] as String? ?? '',
      issuedDate: _parseDateTime(json['issuedDate'] ?? json['issueDate'] ?? json['issuedAt']),
      status: json['status'] as String? ?? 'Pending',
      locationDescription: json['locationDescription'] as String? ?? json['district']?['name'] as String? ?? json['location'] as String?,
      officerContactNumber: json['officerContactNumber'] as String? ?? json['officer']?['phoneNo'] as String? ?? json['officerPhone'] as String?,
